...
unsigned int Material::GetAlbedoIndex()
{
    return albedoIndex;
}

unsigned int Material::GetNormalMapIndex()
{
    return normalMapIndex;
}

unsigned int Material::GetRoughnessIndex()
{
    return roughnessIndex;
}

unsigned int Material::GetMetalnessIndex()
{
    return metalnessIndex;
}
...
void Material::SetAlbedoIndex(unsigned int index)
{
    albedoIndex = index;
}

void Material::SetNormalMapIndex(unsigned int index)
{
    normalMapIndex = index;
}

void Material::SetRoughnessIndex(unsigned int index)
{
    roughnessIndex = index;
}

void Material::SetMetalnessIndex(unsigned int index)
{
    metalnessIndex = index;
}